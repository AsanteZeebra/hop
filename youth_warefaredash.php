...
<head>
  ...
  <title>Youth Monthly Warefare </title>
              ...
              <div class="card-body">
                ...
                <table class="table table-hover" id="example2">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT COUNT(month) AS mnts,SUM(amount) AS amt,fullname,member_id,status FROM dues WHERE status ='Paid' AND department='Youth' GROUP BY fullname ";
              ...
              <div class="card-body">
                ...
                <table class="table table-hover" id="example4">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT member_id,fullname,year,COUNT(month) mnt,status, SUM(amount) am FROM dues WHERE status ='Unpaid' AND department='Youth' GROUP BY fullname ";
                    $run = mysqli_query($con, $sql);
                    if ($run) {
                      while ($row = mysqli_fetch_assoc($run)) {
                        $member_id = $row['member_id'];
                ...
                <tbody style='text-align:center'>
                  ...
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        <td><a
                            href="youth_dues_records.php?idd=<?php echo $member_id ?>&memb=<?php echo $fullname ?> & mid=<?php echo $_GET['mid']; ?>"><?php echo $member_id; ?></a>
                        </td>
                        <td><?php echo $fullname; ?></td>
                        <td><?php echo $telephone; ?></td>
                        <td style="text-align: center;"><?php echo $occupation; ?></td>
