  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Womens Fellowship</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
          ...
          <div class="col-12 col-sm-6 col-md-3">
           ...
           <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Womens list</span>
                <?php
          ...
          <div class="col-12 col-sm-6 col-md-3"> 
           ...
           <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php
                    $sql = "SELECT SUM(amount) AS total FROM exepenses WHERE department='Women' AND status='Rejected' ";
                    $execute = mysqli_query($con, $sql);
                    if ($execute) {
                      while ($row = mysqli_fetch_array($execute)) {
          ...
          <div class="col-12 col-sm-6 col-md-3">
            ...
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <?php
                    $sql = "SELECT SUM(amount) AS total FROM exepenses WHERE department='Women' AND expense_type='Income' AND status='Approved' ";
                    $execute = mysqli_query($con, $sql);
                    if ($execute) {
                      while ($row = mysqli_fetch_array($execute)) {
        ...
        <div class="info-box mb-3">
              ...
              <div class="info-box-content">
               ...
               <?php
                    $sql = "SELECT SUM(amount) AS total FROM dues WHERE department='Women' AND status='Paid' ";
                    $execute = mysqli_query($con, $sql);
                    if ($execute) {
                      while ($row = mysqli_fetch_array($execute)) {
...
?>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="chart-responsive">
                        ...
                        $query = $con->query("SELECT month AS ms,id, COUNT(*) AS sam FROM dues  WHERE year='$year' AND department='Women' AND status='Paid' GROUP BY month  ");
              ...
              <div class="card-footer">
                ...
                <a href="report_today_women.php?mid=<?php echo $_GET['mid']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-print"></i> Today's Report</a>
