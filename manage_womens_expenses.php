  ...
  <div class="modal fade" id="md1">
    ...
    <thead>
            ...
            <?php
                  ...
                  $sql = "SELECT * FROM  exepenses WHERE department='Women' ORDER BY id DESC ";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      $id = $row['transaction_id'];
            ...
            <tfoot>
              <tr>
                ...
                <?php
                  ...
                  $sql = "SELECT sum(amount) as amount FROM exepenses WHERE department='Women'";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
...
<script src="manage_womens_expenses.js"></script>
