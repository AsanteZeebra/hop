  ...
  <div class="card">
    <div class="card-body">
      <div style='float:right;'><a href="#"  data-toggle='modal' data-target='#atmodal' class='btn btn-primary btn-sm'><i class='fa fa-plus'></i> Mark Attendance</a></div>
       <div style='float:left;'><a href="atcard.php?idd=<?php echo $_GET['uid'] ?>& mid=<?php echo $_GET['mid']; ?> &&name=<?php echo $_GET['fname']; ?>" class='btn btn-primary btn-sm'><i class="fa-solid fa-expand"></i> Expand </a></div>
      <br>
      <br>
