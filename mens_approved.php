      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
         <i class="fa-regular fa-circle-check"></i>
          <?php
                  ...
                  $sql = "SELECT COUNT(*) AS cc FROM exepenses WHERE status='Approved' AND department='Men'";
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
             <?php
                  ...
                  $sql = "SELECT * FROM exepenses WHERE status='Approved' AND department='Men' ORDER BY id DESC LIMIT 3";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <i class="fa-solid fa-ban"></i>
           <?php
                  ...
                  $sql = "SELECT COUNT(*) AS cc FROM exepenses WHERE status='Rejected' AND department='Men'";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      $number = $row['cc'];
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
         <?php
                  ...
                  $sql = "SELECT * FROM exepenses WHERE status='Rejected' AND department='Men'";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      $name = $row['beneficiary'];
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <table class="table">
                  ...
                  $sql = "SELECT * from  exepenses WHERE status='Pending' AND department='Men' ORDER BY date_created DESC";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
  ...
  <div class="modal fade" id="md1">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <table class="table">
                  ...
                  $sql = "SELECT * from  exepenses WHERE status='Approved' AND department='Men' ORDER BY date_created DESC";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      $id = $row['transaction_id'];
    ...
    <table class='table table-hover' id="example1">
            ...
            <?php
                  ...
                  $sql = "SELECT * FROM  exepenses WHERE status='Approved' AND department='Men' ";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      $id = $row['transaction_id'];
            ...
            <tfoot>
              <tr>
                ...
                <?php
                  ...
                  $sql = "SELECT sum(amount) as amount FROM exepenses WHERE status='Approved' AND department='Men'";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
