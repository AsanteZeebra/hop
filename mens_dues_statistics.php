...
$mem_id = $_GET['mid'];
     ...
     $sql = "SELECT COUNT(*) as mt FROM mens_warefare WHERE member_id='$mem_id' AND status='Paid'";
...
$mem_id = $_GET['mid'];
     ...
     $sql = "SELECT COUNT(*) as mt FROM mens_warefare WHERE member_id='$mem_id' AND status='Unpaid'";
     $run = mysqli_query($con, $sql);
     if ($run) {
       while ($row = mysqli_fetch_assoc($run)) {
 ...
 <div class="col-6">
  ...
  <?php
       ...
       $mem_id =$_GET['mid'];
                ...
                $query = $con->query("SELECT year AS ys, COUNT(amount) sam FROM dues  WHERE status='Paid' AND member_id='$mem_id' AND department='Men' GROUP BY ys ");
...
<div class="col-6">
  ...
  <?php
                 ...
                 $mem_id =$_GET['mid'];
                $query = $con->query("SELECT COUNT(status) AS ct, status AS st FROM dues WHERE member_id='$mem_id' AND department='Men' GROUP BY st");
...
$year = date('Y');
     ...
     $sql = "SELECT * FROM dues WHERE member_id='$mem_id' AND year='$year' AND department='Men'";
     $run = mysqli_query($con, $sql);
     if ($run) {
       while ($row = mysqli_fetch_assoc($run)) {
...
$lastyear = $year-1;
     $sql = "SELECT * FROM dues WHERE member_id='$mem_id' AND year='$lastyear' AND department='Men'";
     $run = mysqli_query($con, $sql);
     if ($run) {
       while ($row = mysqli_fetch_assoc($run)) {
