        ...
        <table class="table table-bordered" style="width: 100%; border-collapse: collapse;">
          ...
          <tbody>
            ...
            $sql = "SELECT transaction_id, category, SUM(amount) AS mt, expense_type, date 
                    FROM exepenses WHERE month='$month' AND year='$year' AND status='Approved' AND department='$department' GROUP BY category";
          ...
          <table class="table table-bordered" style="width: 100%; border-collapse: collapse;">
            <tbody>
              ...
              $sql = "SELECT SUM(amount) AS icom 
                      FROM exepenses 
                      WHERE expense_type='Income' AND month='$month' AND year='$year'AND department='$department'  AND status='Approved'";
              $result = mysqli_query($con, $sql);
              ...
              $sql = "SELECT SUM(amount) AS ex 
                      FROM exepenses 
                      WHERE expense_type='Expenditure' AND month='$month' AND year='$year' AND department='$department' AND status='Approved'";
              $result = mysqli_query($con, $sql);
