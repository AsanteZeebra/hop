 ...
 <div class="col-12">
  <div class="card">
    ...
    <div class="col-md-2 col-sm-6 col-12" >
          ...
          <div class="col-md-2 col-sm-6 col-12">
            <a href="manage_expenses.php? mid=<?php echo $_GET['mid']; ?> && dept=<?php echo $_GET['dept']; ?>">
  ...
  <div class="col-md-12">
     <!-- PIE CHART -->
        ...
        $year = date('Y');
         ...
         $query = $con->query("SELECT month AS ms,id, SUM(amount) sam FROM exepenses  WHERE year='$year' AND status='Approved' AND expense_type='Income' AND department='Main' GROUP BY month ORDER BY id ASC ");
...
$year = date('Y');
 ...
 $query = $con->query("SELECT month AS ms1,id, SUM(amount) sam1 FROM exepenses  WHERE year='$year' AND status='Approved' AND expense_type='Expenditure' AND department='Main' GROUP BY month ORDER BY id ASC");
