  ...
  <div class="sidebar">
      ...
      <div class="info">
        ...
        if ($run) {
          while ($row = mysqli_fetch_assoc($run)) {
            ...
            ?>
            <a href="welfare.php?mid=<?php echo $_GET['mid']; ?> &&dept=<?php echo $_GET['dept'] ?>"
              class="d-block"><?php echo $name; ?></a>
          <?php }
        } else {
          echo "No Records Found";
        } ?>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item ">
          <a href="ad_dashboard.php?mid=<?php echo $_GET['mid'] ?> &&dept=<?php echo $_GET['dept'] ?>"
            class="nav-link ">
        ...
        <li class="nav-item">
          <a href="benefit_claims.php?mid=<?php echo $_GET['mid']; ?> &&dept=<?php echo $_GET['dept'] ?>"
            class="nav-link">
        ...
        <li class="nav-item">
          <a href="general_expenses.php?mid=<?php echo $_GET['mid']; ?> &&dept=<?php echo $_GET['dept'] ?>"
            class="nav-link">
        ...
        <li class="nav-item">
          <a href="welfare_reports.php?mid=<?php echo $_GET['mid'] ?> &&dept=<?php echo $_GET['dept'] ?>"
            class="nav-link">
