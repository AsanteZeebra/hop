  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> Womens Welfare Report <?php echo date('Y') ?></h1>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card">
      <div class="card-body">
        <a href="report_women.php?mid=<?php echo $_GET['mid'] ?>" class="btn btn-primary" style="float:right;">Create & Send Report <i class="fa fa-receipt" ></i></a>
      </div>
    </div>
    <!-- Main content -->
...
$year = date('Y');
$query = $con->query("SELECT COUNT(amount) AS ct, month AS st FROM  dues WHERE status='Paid' AND year='$year' AND department='Women' GROUP BY month ");
...
$year = date('Y');
$query = $con->query("SELECT COUNT(amount) AS ct, month AS st FROM  dues WHERE status='Unpaid' AND year='$year'AND department='Women' GROUP BY month ");
     ...
     <button type="submit" class="btn btn-primary" style="margin-top: 10px;">Fetch</button>
      ...
      <table class="table table-hover" id="example4">
        ...
        <?php
                  ...
                  $sql = "SELECT * from  dues WHERE department='Women' ";
