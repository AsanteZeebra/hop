      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            $sql = "SELECT COUNT(*) AS cc FROM exepenses WHERE status='Declined'";
            $result = mysqli_query($con, $sql);
            if ($result) {
              while ($row = mysqli_fetch_array($result)) {
                $number = $row['cc'];
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            $sql = "SELECT * FROM exepenses WHERE status='Declined'";
            $result = mysqli_query($con, $sql);
            if ($result) {
              while ($row = mysqli_fetch_array($result)) {
                $name = $row['beneficiary'];
                ...
                ?>
                <a href="#" class="dropdown-item">
                  <i class="fa-solid fa-ban mr-2"></i> <?php echo $name ?>
              ...
              <div class="card-body">
                ...
                <table class='table table-hover' id="example1">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM  exepenses WHERE status='Approved' ";
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      while ($row = mysqli_fetch_array($result)) {
                        $id = $row['transaction_id'];
                  ...
                  <tfoot>
                    <tr>
                      ...
                      $sql = "SELECT sum(amount) as amount FROM exepenses WHERE status='Approved'";
                      $result = mysqli_query($con, $sql);
                      if ($result) {
                        while ($row = mysqli_fetch_array($result)) {
