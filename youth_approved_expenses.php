  ...
  <div class="modal fade" id="md1">
    ...
    <table class='table table-hover' id="example1">
            ...
            <?php
                  ...
                  $sql = "SELECT * FROM  exepenses WHERE status='Approved' AND department='Youth' ";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
                      $id = $row['transaction_id'];
              ...
              <tr>
               ...
               <td></td>
                ...
                <?php
                  ...
                  $sql = "SELECT sum(amount) as amount FROM exepenses WHERE status='Approved' AND department='Youth'";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
