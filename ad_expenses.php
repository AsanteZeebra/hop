...
<?php
    ...
    <div class="col-md-2 col-sm-6 col-12" >
           ...
           <div class="info-box" style="background-color:#233F93">
              ...
              <div class="info-box-content">
                <span class="info-box-text" style="color:white">Create</span>
          ...
          <div class="col-md-2 col-sm-6 col-12">
            <a href="ad_manage_expenses.php? mid=<?php echo $_GET['mid']; ?> && dept=<?php echo $_GET['dept']; ?>">
            <div class="info-box " style="background-color: #C8A43E">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-text" style="color:white">Manage</span>
                <span class="info-box-number" style="color:white"> </span>
          ...
          <div class="col-md-2 col-sm-6 col-12">
           <a href="ad_approved_expenses.php? mid=<?php echo $_GET['mid']; ?> && dept=<?php echo $_GET['dept'] ?>">
           <div class="info-box bg-gradient-success">
              <span class="info-box-icon"><i class="fa-solid fa-check-double"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" style="color:white">Approvals</span>
                <span class="info-box-number" style="color:white"></span> 
                <div class="progress">
                  <div class="progress-bar" style="width: 70%"></div>
                </div>
 ...
 <div class="col-md-2 col-sm-6 col-12">
           <a href="ad_rejected_expenses.php? mid=<?php echo $_GET['mid']; ?> &&dept=<?php echo $_GET['dept'] ?>">
           <div class="info-box bg-gradient-danger">
              <span class="info-box-icon"><i class="fa fa-times"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" style="color:white">Rejected</span>
                <span class="info-box-number" style="color:white"></span> 
                <div class="progress">
                  <div class="progress-bar" style="width: 70%"></div>
                </div>
          ...
          <div class="col-md-2 col-sm-6 col-12">
           <a href="ad_expenses_report.php? mid=<?php echo $_GET['mid']; ?> && dept=<?php echo $_GET['dept'] ?>">
           <div class="info-box bg-gradient-dark">
              <span class="info-box-icon"><i class="fa fa-receipt"></i></span>

              <div class="info-box-content">
                <span class="info-box-text" style="color:white">Reports</span>
                <span class="info-box-number" style="color:white"></span> 
                <div class="progress">
                  <div class="progress-bar" style="width: 70%"></div>
                </div>
...
<div class="row">
  <div class="col-md-12">
     <!-- PIE CHART -->
        ...
        $year = date('Y');
$department = $_GET['dept'];
         $query = $con->query("SELECT month AS ms,id, SUM(amount) sam FROM exepenses  WHERE year='$year' AND status='Approved' AND expense_type='Income' AND department='$department' GROUP BY month ORDER BY id ASC ");
...
$year = date('Y');
$department = $_GET['dept'];
 $query = $con->query("SELECT month AS ms1,id, SUM(amount) sam1 FROM exepenses  WHERE year='$year' AND status='Approved' AND expense_type='Expenditure' AND department='$department' GROUP BY month ORDER BY id ASC");
