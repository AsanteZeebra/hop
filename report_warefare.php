        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="youth_dashboard.php?mid=<?php echo $_GET['mid'] ?>" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="col-md-12">
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                              ...
                              <a href="report_list_warefare.php?mid=<?php echo $_GET['mid']; ?>" class="btn btn-primary btn-sm " style="float:right;" ><i class="fa-solid fa-receipt"></i> Report List</a>
                            </div>
                            <!-- /.card-header -->
