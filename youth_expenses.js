$(function () {
  ...
  function record_expenses() {
      ...
      var id = $(".tfidd").val(); // Changed from 'idd' to 'id' for consistency
      var type = $('.tftype').val(); // Changed from 'extype' to 'type' for consistency
  ...
  $("#ywarefare").validate({
      ...
      messages: {
          ...
          type: {
              required: "Please choose an expense type",
          },
      },
      errorElement: "span",
