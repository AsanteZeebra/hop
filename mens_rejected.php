          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <table class="table">
                  ...
                  $sql = "SELECT * from  exepenses WHERE status='Pending' AND deparment='Men' ORDER BY date_created DESC";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
            ...
            <tfoot>
              <tr>
                ...
                <?php
                  ...
                  $sql = "SELECT sum(amount) as amount FROM exepenses WHERE status='Rejected' AND department='Men'";
                  $result = mysqli_query($con, $sql);
                  if ($result) {
                    while ($row = mysqli_fetch_array($result)) {
