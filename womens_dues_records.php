...
<body class="hold-transition sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          ...
          $mem_id = $_GET['idd'];
          $sql = "SELECT COUNT(month) as month,fullname FROM dues WHERE member_id='$mem_id' AND status='Unpaid' AND department='Women' ";
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                <div>
                  <a href="womens_dues_statistics.php?&mid=<?php echo $_GET['idd'] ?>&&memb=<?php echo $_GET['memb'] ?>"
                ...
                <table class="table table-hover " table id="example1">
                  ...
                  <tbody>
                    ...
                    $mem_id = $_GET['idd'];
                    $sql = "SELECT * FROM dues WHERE member_id='$mem_id' AND department='Women' ORDER BY year DESC ";
                    $run = mysqli_query($con, $sql);
                    if ($run) {
                      while ($row = mysqli_fetch_assoc($run)) {
  ...
  <script src="validate_womens_dues.js"></script>
