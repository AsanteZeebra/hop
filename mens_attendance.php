                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover" id="example1">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * from  members WHERE gender='Male' AND age > 28 OR marital_status='married' AND gender='Male'";
                                    ...
                                    if ($run) {
                                        while ($row = mysqli_fetch_assoc($run)) {
                                            ...
                                            <tr style="text-align:center">
                                                ...
                                                <td><a
                                                        href="mens_attendance_records.php? idd=<?php echo $member_id; ?>& fname=<?php echo $name; ?> &&mid=<?php echo $_GET['mid']; ?>">
