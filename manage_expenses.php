      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            $sql = "SELECT COUNT(*) AS cc FROM exepenses WHERE status='Approved'";
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            $sql = "SELECT * FROM exepenses WHERE status='Approved' ORDER BY id DESC LIMIT 3";
            $result = mysqli_query($con, $sql);
            if ($result) {
              while ($row = mysqli_fetch_array($result)) {
            ...
            <div class="dropdown-divider"></div>
            <a href="#" data-toggle="modal" data-target="#md1" class="dropdown-item dropdown-footer">See All
              Messages</a>
          </div>
        </li>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" data-toggle="dropdown" href="#">
            ...
            $sql = "SELECT COUNT(*) AS cc FROM exepenses WHERE status='Rejected'";
            $result = mysqli_query($con, $sql);
            if ($result) {
              while ($row = mysqli_fetch_array($result)) {
                $number = $row['cc'];
              ...
              <div class="card-body">
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" data-toggle="modal" data-target="#md"
                          aria-label="Close">
                      ...
                      <div class="modal-body">
                        <form method="POST">
                          ...
                          <table class="table">
                            ...
                            <tr>
                              <td colspan="5"><textarea disabled name="" id="" cols="100" rows="5" style="border:none"
                                  class="td5"> </textarea></td>
                            ...
                            if ($result) {
                              while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                  ...
                                  <td><a href="" data-toggle="modal" data-dismiss="modal" data-target="#sm"
                                      class="tdedit"><?php echo $status ?></a> </td>
                                  <?php
                                  if ($department === 'Men') {
                                    echo "<td><label for='' class='badge badge-info'>Mens Department</label></td>";
                                  } else if ($department === 'Women') {
                                    echo "<td><label for='' class='badge badge-info'>Womens Department</label></td>";
                                  } else if ($department === 'Youth') {
                                    echo "<td><label for='' class='badge badge-info'>Youth Department</label></td>";
                                  } else if ($department === 'Main') {
                                    echo "<td><label for='' class='badge badge-info'>General Warefare</label></td>";
                                  } else if ($department === 'Children') {
                                    echo "<td><label for='' class='badge badge-info'>Childrens Department</label></td>";
                                  }
                                  ?>
                ...
                <table class='table table-hover' id="example1">
                  ...
                  <tbody>
                    ...
                    $sql = "SELECT * FROM  exepenses ORDER BY id DESC ";
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      while ($row = mysqli_fetch_array($result)) {
                        $id = $row['transaction_id'];
                        ...
                        <tr>
                          ...
                          <td style='text-align:center;'> <a href="#" class='text-muted' data-toggle="modal"
                              data-target="#md"><i class="fa-regular fa-pen-to-square"></i></a> <a href="#"
                              class="text-muted btdel" data-toggle='modal' data-target='#mdquestion'><i
                  ...
                  <tfoot>
                    ...
                    $sql = "SELECT sum(amount) as amount FROM exepenses";
                    $result = mysqli_query($con, $sql);
                    if ($result) {
                      while ($row = mysqli_fetch_array($result)) {
