              ...
              <div class="card-body">
                ...
                <div class="row" style="justify-content: center; margin-top:60px;">
                  <div class="col-md-3 col-sm-6 col-12">
                    <a href="add_youth_expenses.php? uid=<?php echo uniqid(); ?> &mid=<?php echo $_GET['mid'] ?>">
                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                    <a href="manage_youth_expenses.php?mid=<?php echo $_GET['mid']; ?>">
                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                    <a href="youth_approved_expenses.php?mid=<?php $_GET['mid']; ?>">
                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                    <a href="youth_rejected_expenses.php?mid=<?php $_GET['mid']; ?>">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-success">
                  ...
                  <div class="card-body">
                    ...
                    $query = $con->query("SELECT month AS ms,id, SUM(amount) sam FROM exepenses  WHERE year='$year' AND status='Approved' AND expense_type='Income' AND department='Youth' GROUP BY month ORDER BY id ASC ");
                    ...
                    $query = $con->query("SELECT month AS ms1,id, SUM(amount) sam1 FROM exepenses  WHERE year='$year' AND status='Approved' AND expense_type='Expenditure' AND department='Youth' GROUP BY month ORDER BY id ASC");
