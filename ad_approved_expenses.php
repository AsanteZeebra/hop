                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">approved_expenses</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <button type="button" class="close" data-dismiss="modal"
                                                    data-toggle="modal" data-target="#md" aria-label="Close">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td colspan="5"><textarea disabled name="" id="" cols="100"
                                            ...
                                            <div class="modal-body">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $department = $_GET['dept'];
                                                        $sql = "SELECT * from  exepenses WHERE status='Pending' AND department='$department' ORDER BY id DESC";
                                                        ...
                                                        if ($result) {
                                                            while ($row = mysqli_fetch_array($result)) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="" data-toggle="modal" data-dismiss="modal"
                                                                            data-target="#sm"
                                            ...
                                            <div class="modal-body">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $department = $_GET['dept'];
                                                        $sql = "SELECT * from  exepenses WHERE status='Approved' AND department='$department' ORDER BY id DESC";
                                                        $result = mysqli_query($con, $sql);
                                                        if ($result) {
                                                            while ($row = mysqli_fetch_array($result)) {
                                                                $id = $row['transaction_id'];
                                ...
                                <table class='table table-hover' id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        $department = $_GET['dept'];
                                        $sql = "SELECT * FROM  exepenses WHERE status='Approved' AND department='$department' ";
                                        $result = mysqli_query($con, $sql);
                                        if ($result) {
                                            while ($row = mysqli_fetch_array($result)) {
                                                $id = $row['transaction_id'];
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            $department = $_GET['dept'];
                                            $sql = "SELECT sum(amount) as amount FROM exepenses WHERE status='Approved' AND expense_type='Income' AND department='$department'";
                                            $result = mysqli_query($con, $sql);
                                            if ($result) {
                                                while ($row = mysqli_fetch_array($result)) {
